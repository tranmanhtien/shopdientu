...
@endsection
 @section('content')
  ...
  <section id="aa-catg-head-banner">
   <img src="upload/images/banner7.jpg" alt="fashion img">
     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          @foreach($brandsp as $br)        
            <li class="active">{{$br->name}}</li>
          @endforeach
        </ol>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
          ...
          <div class="col-sm-12" style="text-align: center;">{{$sp_brand->links()}}</div>  
        </div>
        <div class="col-lg-3 col-md-3 col-sm-4 col-md-pull-9">
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <ul class="aa-catg-nav">
                 @foreach($brandsp as $catename) 
                    <li><a href="pages/loaithuonghieu/{{$catename->id}}/{{$price=1}}">Dưới 8 triệu</a></li>
                    <li><a href="pages/loaithuonghieu/{{$catename->id}}/{{$price=2}}">Từ 8 - 12 triệu</a></li>
                    <li><a href="pages/loaithuonghieu/{{$catename->id}}/{{$price=3}}">Trên 12 triệu</a></li>
                 @endforeach 
              </ul>
            </div>
            <!-- single sidebar -->
